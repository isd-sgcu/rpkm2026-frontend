...
const EmergencyPanel = () => {
  ...
  return (
    <>
      {/*  Header  */}
      <div className="w-full flex flex-col items-center gap-2 text-foreground">
        <PhoneCall />
          ...
          return (
            <div
              ...
              className={cn(
                ...
                "h-fit px-6 py-4 flex flex-col gap-2 items-center whitespace-normal",
              )}
            >
              {phone1 && (
                <a
                ...
                >
                  <PhoneCall fill="var(--color-primary-foreground)" />
                  <span>{phone1}</span>
                </a>
              )}
              {phone2 && (

...
export default function HouseSelectPopup({
  ...
  return (
    <>
      {viewState === "list" && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white/70 gap-5">
          <div className="flex flex-col justify-center items-center bg-rpkm-beige rounded-4xl border shadow-lg max-w-md mx-4">
            {/* search */}
            ...
            <div className="w-full">
              ...
              {/* list */}
              <div className="flex h-[70dvh] flex-col rounded-b-xl bg-rpkm-red p-6 border rounded-4xl">
                {/* Top 20% */}
                <div className="pb-4">

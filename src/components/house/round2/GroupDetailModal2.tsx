...
type DialogState =
  ...
  | { type: "delete" }
  | { type: "leave" }
  | { type: "kick"; member: Group2Member }
  | { type: "blocked" };

function memberName(member: Group2Member) {
...
export default function GroupDetailModal2({
  currentUserId,
  onClose,
}: {
  ...
  const regenerateMutation = useMutation({
    mutationFn: regenerateJoinCode2,
    onSuccess: () => {

                ...
                return (
                  ...
                  >
                    <div className="relative w-full">
                      ...
                      {isUnavailable ? (
                        <div className="absolute inset-x-0 bottom-0 flex h-5 items-center justify-center rounded-[10px] border bg-gray-500 px-2">
                          <span className="text-[10px] leading-none text-white">
                            {t("house.popup.unavailable")}
                          </span>
                        </div>
                      ) : (
